...
<head>
        <meta charset="utf-8" />
        <title>Reset Password - Mom and Paw</title>
                            ...
                            <div class="card-body">
                                ...
                                <form class="login-form mt-4">
                                    <div class="row">
                                        ...
                                        <div class="mx-auto">
                                            <p class="mb-0 mt-3"><small class="text-dark mr-2">Remember your password ?</small> <a href="signin.php" class="text-dark font-weight-bold">Sign in</a></p>
                                        </div>
                                    </div>
                                </form>
                            </div>
